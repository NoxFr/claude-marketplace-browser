    ...
    <div class="max-w-[800px] mx-auto">
      <section class="mb-stack-lg">
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-stack-md mb-stack-md">
          ...
          <button class="px-stack-md py-stack-sm bg-vibrant-blue text-white font-body-base text-body-base rounded-lg hover:opacity-90 transition-opacity flex items-center gap-stack-sm">
