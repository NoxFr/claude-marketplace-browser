...
const COMPONENT_TYPES = [
  { field: 'commands',   dir: 'commands', label: 'Command' },
  { field: 'agents',     dir: 'agents',   label: 'Agent' },
  { field: 'hooks',      dir: 'hooks',    label: 'Hook' },
  { field: 'mcpServers', dir: 'mcp',      label: 'MCP' },
  { field: 'lspServers', dir: 'lsp',      label: 'LSP' },
];
...
function readAgentDetail(name) {
  ...
  if (agent.skills) {
    ...
    if (files.length > 0) components.push({ label: 'Skill', files });
  }
