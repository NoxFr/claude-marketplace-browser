...
Chaque card SHALL afficher : une icône Material Symbols dans un container `bg-slate-900`, la version en `font-code-sm`, le titre en `font-headline-md`, la description sur 2 lignes max (`line-clamp-2`), et les badges en bas.
